        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-5 max-w-[42ch]">
              ...
              >
我以可被驗證的設計決策為目標，整合多方關係人的立場，轉譯成一個能真正解決問題的體驗。同時利用AI工具，加快迭代過程，與團隊更專注於「做出一個好的產品」的決策上。
              </p>
              <p
                className="text-base md:text-lg leading-relaxed"
                style={{ fontFamily: "var(--font-inter)", color: "#40474a" }}
              >
                我的背景從廣告業的美術創意，到設計顧問公司的策展企劃與數位體驗設計。在過程中逐漸發現，若只專注於視覺的精緻，較少深入探究使用者的困難是否有改善，會是非常可惜的一件事。這讓我在2022年開始以服務設計的系統化思考看待設計流程，並更以使用者為核心進行研究與設計，為社會、企業，及使用者創造一個更完整的設計體驗。
              </p>
            </div>
          </motion.div>
