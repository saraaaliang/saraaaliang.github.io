...
export const sdgEnergyContent: SdgEnergyContent = {
  ...
  hero: {
    ...
    description:
      "識別舊有版本用戶痛點，重新設計體驗流程與架構，成功解決用戶中途離開問題，優化體驗易用性，增加親子族群對能源的認識。過程中我在三版手勢迭代（旋鈕→滑動→儀表板）中反覆權衡工程限制與體驗直覺性，主導定案最終視覺方向。",
    role: "UI/UX 設計師",
  ...
  impact: {
    ...
    stats: [
      ...
      },
      {
        icon: "check",
        title: "超過90%觀眾完成體驗",
        description: "展覽期間透過工程團隊回饋的後台資料及現場觀察顯示，與舊版相比，使用者中途放棄的狀況大幅減少。",
      },
      {
        icon: "people",
        title: "團隊後續採用",
